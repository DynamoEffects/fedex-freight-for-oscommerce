...
//---FedEx Freight Modification START ---//
                                  'products_fxf_class' => tep_db_prepare_input($HTTP_POST_VARS['products_fxf_class']),
                                  'products_fxf_desc' => tep_db_prepare_input($HTTP_POST_VARS['products_fxf_desc']),
                                  'products_fxf_nmfc' => tep_db_prepare_input($HTTP_POST_VARS['products_fxf_nmfc']),
                                  'products_fxf_haz' => tep_db_prepare_input($HTTP_POST_VARS['products_fxf_haz']),
                                  'products_fxf_freezable' => tep_db_prepare_input($HTTP_POST_VARS['products_fxf_freezable']),
...
//---FedEx Freight Modification START ---//
    $fx_freight_vals = array('050', '055', '060', '065', '070', '077', '085', '092', '100', '110', '125', '150', '175', '200', '250', '300');
    $fx_freight_array = array();
    
    foreach($fx_freight_vals as $val) {
      $fx_freight_array[] = array('id' => $val, 'text' => $val);
    }
//---FedEx Freight Modification END ---//
...
<? //---FedEx Freight Modification START ---// ?>
          <tr bgcolor="#ebebff">
            <td class="main" colspan=2 style="border-bottom:1px solid #000000"><?php echo TEXT_PRODUCTS_FXFREIGHT; ?></td>
          </tr>
          <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_FXFREIGHT_CLASS; ?></td>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_pull_down_menu('products_fxf_class', $fx_freight_array, $pInfo->products_fxf_class); ?></td>
          </tr>
          <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_FXFREIGHT_DESCR; ?></td>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('products_fxf_desc', $pInfo->products_fxf_desc, 'maxlength=100'); ?></td>
          </tr>
          <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_FXFREIGHT_NMFC; ?></td>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('products_fxf_nmfc', $pInfo->products_fxf_nmfc, 'maxlength=100'); ?></td>
          </tr>
          <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_FXFREIGHT_HAZ; ?></td>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_pull_down_menu('products_fxf_haz', array(array('id' => '1', 'text' => 'Yes'), array('id' => '0', 'text' => 'No')), $pInfo->products_fxf_haz); ?></td>
          </tr>
          <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_FXFREIGHT_FREEZE; ?></td>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_pull_down_menu('products_fxf_freezable', array(array('id' => '1', 'text' => 'Yes'), array('id' => '0', 'text' => 'No')), $pInfo->products_fxf_freezable); ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
