...
define('TEXT_PRODUCTS_FXFREIGHT', '<b>FedEx Freight Shipping Information</b>');
define('TEXT_PRODUCTS_FXFREIGHT_CLASS', 'Freight Class:');
define('TEXT_PRODUCTS_FXFREIGHT_DESCR', 'Commodity Description: (Optional)');
define('TEXT_PRODUCTS_FXFREIGHT_NMFC', 'NMFC number: (Optional)');
define('TEXT_PRODUCTS_FXFREIGHT_HAZ', 'Require a hazardous indicator?');
define('TEXT_PRODUCTS_FXFREIGHT_FREEZE', 'Require freezable protection?');
